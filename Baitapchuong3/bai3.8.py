import numpy as np
with open('E:/Bài tập lập trình nâng cao/Bai_tap_van_dung_chuong_3/heights.txt', 'r') as file:
    heights = [float(line.strip()) for line in file if line.strip()]
with open('E:/Bài tập lập trình nâng cao/Bai_tap_van_dung_chuong_3/positions.txt', 'r') as file:
